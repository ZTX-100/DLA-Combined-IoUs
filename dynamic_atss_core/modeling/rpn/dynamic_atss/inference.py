...
from dynamic_atss_core.structures.boxlist_ops import boxlist_ml_nms
from dynamic_atss_core.structures.boxlist_ops import remove_small_boxes


class DynamicATSSPostProcessor(torch.nn.Module):
    def __init__(
        self,
        pre_nms_thresh,
        pre_nms_top_n,
        ...
        super(DynamicATSSPostProcessor, self).__init__()
...
def make_dynamic_atss_postprocessor(config, box_coder):

    box_selector = DynamicATSSPostProcessor(
